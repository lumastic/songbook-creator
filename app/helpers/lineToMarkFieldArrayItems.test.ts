...
describe("Array length", () => {
  test("should convert line to an array of 30 elements minimum", () => {
  ...
  test("should convert line to an array of 1 greater than length of lyrics if over 30 characters", () => {
